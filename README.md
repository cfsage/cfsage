<h1 align="center">
  <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Smilies/Waving%20Hand.png" alt="Waving Hand" width="40" /> Hi there, I'm Biplove Yadav (@cfsage)
</h1>
...
## <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Laptop.png" alt="Laptop" width="25" /> Tech Stack & Skills

<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=py,js,ts,react,nextjs,nodejs,fastapi,mongodb,postgres,docker,kubernetes,azure,linux,git,github" alt="Tech Stack Icons" />
  </a>
</p>

* [cite_start]**Frontend:** React, Next.js, HTML/CSS, Tailwind CSS[cite: 23, 124].
* [cite_start]**Backend:** Node.js, FastAPI, MongoDB, PostgreSQL, Supabase, Express.js[cite: 25, 126].
* [cite_start]**AI & Machine Learning:** LLM Pre-training, RAG, PyTorch, NLP, ChromaDB, Transformer Architectures (Gemma/DeepSeek)[cite: 18, 117].
* [cite_start]**Security:** VAPT, Nmap, Nessus, OpenVAS (GVM), Burp Suite, Compliance Auditing (ISO/NIST)[cite: 16, 115].
* [cite_start]**Cloud & DevOps:** Oracle Cloud Infrastructure (OCI), Docker, Kubernetes, CI/CD Pipelines[cite: 19, 119].
* [cite_start]**Networking:** IP Addressing, Subnetting, OSPF, EIGRP, VLANs, STP[cite: 27, 128].

---

## <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Activities/Trophy.png" alt="Trophy" width="25" /> Certifications & Achievements
* [cite_start]**Oracle Certifications:** OCI 2025 Certified DevOps Professional, Architect Associate, Data Science Professional, and Generative AI Professional[cite: 73, 77, 167, 171]. [cite_start]Oracle AI Vector Search Certified Professional[cite: 76, 170].
* [cite_start]**Google & Meta:** Google IT Support Specialization[cite: 80, 174]. [cite_start]Meta Front-End Developer Specialization and Meta Social Media Marketing[cite: 81, 83, 175, 177].
* [cite_start]**Hackathon Success:** 3rd place for Sankat Sanket out of 10 teams[cite: 64, 159]. [cite_start]Engineered a full-stack emergency response system that placed top 3 out of 20 competing projects at ISMT[cite: 87, 181].
* [cite_start]**Event Management:** Organized and managed the ISMT PUBG Mobile Showdown 2025 for 66 teams[cite: 91, 185]. [cite_start]Managed conflict resolution and technical coordination using Discord and Google Forms[cite: 92, 186].
...
<p align="center">
  <b>Let's collaborate!</b> Feel free to explore my repositories or reach out to discuss AI, cloud infrastructure, or cybersecurity.
</p>
